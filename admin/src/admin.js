...
const HiddenAppBar = withStyles({
  ...
  return <AppBar {...props} className={classes.hideOnDesktop} />
})
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (itaSchemas) {
    customRoutes.push(<Route path="/server-setup" render={props => <ServiceEditor {...props} schema={itaSchemas} />} />)
  }

  const layout = props => (
    <Layout {...props} appBar={AppBar} menu={props => <AdminMenu {...props} services={schemaCategories} />} />
  )
